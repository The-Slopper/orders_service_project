...
| Campo | Valor |
|---|---|
| Repositorio | `orders_service_project` |
...
Servico de pedidos: ciclo de vida, itens e integracao com pagamento. Este documento descreve requisitos, arquitetura e criterios de aceite.
...
Segue o scaffold idiomatico de JavaScript: codigo-fonte, testes e manifesto de build
...
- [ ] `npm start` executa o componente.
- [ ] `npm test` passa (CI verde, cobertura 100%).
