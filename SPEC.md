# Especificacao Tecnica — Orders Service

| Field | Value |
|---|---|
| Repository | `orders_service_project` |
...
Service of orders: ciclo of vida, items and integracao with payment. This document describes requirements, architecture, and acceptance criteria.
...
Follows the scaffold idiomatico of JavaScript: code-fonte, tests and manifesto of build
...
- [ ] `npm install` conclui without errors.
- [ ] `npm start` executa the componente.
- [ ] `npm test` passa (CI green, coverage 100%).
